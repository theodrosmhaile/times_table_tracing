...
prepare_level_data <- function(data, level) {
  data %>%
    filter(level == level) %>%
...
```{r}
generate_descriptive_data <- function(data, level_filter = NULL) {
  ...
  data %>%
    ...
    mutate('multiplier' = paste0("col",matrix(1:10,10,10) %>% t() %>% c()),
    'multiplicand' = rep(c(1:10), 10)) %>%
    mutate(cue_text=fct_reorder(cue_text,multiplicand))
}

# Generate descriptive data
dat4plot_level1 <- generate_descriptive_data(dat, level_filter = 1)
dat4plot_level2 <- generate_descriptive_data(dat, level_filter = 2)
dat4plot_level3 <- generate_descriptive_data(dat, level_filter = 3)
...
# Heatmaps
heatmap_level1 <- plot_heatmap(dat4plot_level1, "Heatmap of Mean Accuracy (Level 1)")
heatmap_level2 <- plot_heatmap(dat4plot_level2, "Heatmap of Mean Accuracy (Level 2)")
heatmap_level3 <- plot_heatmap(dat4plot_level3, "Heatmap of Mean Accuracy (Level 3)")

# Bar Plots
barplot_level1 <- plot_barplot(dat4plot_level1, "Bar Plot of Mean Accuracy (Level 1)")
barplot_level2 <- plot_barplot(dat4plot_level2, "Bar Plot of Mean Accuracy (Level 2)")
barplot_level3 <- plot_barplot(dat4plot_level3, "Bar Plot of Mean Accuracy (Level 3)")

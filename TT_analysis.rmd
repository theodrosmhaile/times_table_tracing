...
correlation_results <- bind_rows(
  combine_correlation_data("Level 2", "First", l2_first_3sk, dat_level2_first),
  combine_correlation_data("Level 2", "Middle", l2_middle_3sk, dat_level2_middle),
  combine_correlation_data("Level 2", "Last", l2_last_3sk, dat_level2_last),
  combine_correlation_data("Level 3", "First", l3_first_3sk, dat_level3_first),
  combine_correlation_data("Level 3", "Middle", l3_middle_3sk, dat_level3_middle),
  combine_correlation_data("Level 3", "Last", l3_last_3sk, dat_level3_last)
)
...
ggplot(correlation_results, aes(x = skill, y = pearsons_r, fill = skill)) +
  geom_bar(stat = "identity", position = "dodge", width = 0.7) +
  facet_grid(level ~ encounter) +
  theme_minimal() +
  labs(
